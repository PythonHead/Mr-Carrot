...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title("Mr.Carrot Races for the Exit")
...
class StickFigureSprite(Sprite):
    def __init__(self,game):
        Sprite.__init__(self,game)
        self.images_left = [
            PhotoImage(file="carrot-L1.gif"),
            PhotoImage(file="carrot-L2.gif"),
            PhotoImage(file="carrot-L3.gif")
        ]
        self.images_right = [
            PhotoImage(file="carrot-R1.gif"),
            PhotoImage(file="carrot-R2.gif"),
            PhotoImage(file="carrot-R3.gif")
        ]
